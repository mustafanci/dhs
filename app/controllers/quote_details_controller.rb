class QuoteDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @quote_detail.save
        ...
        #format.html { redirect_to root_path, notice: 'Quote detail was successfully updated.' }
  ...
  private
    ...
    def quote_detail_params
      params.require(:quote_detail).permit(:name, :email, :phone, :city, :county, :customer, :service, :description)
    end
end
